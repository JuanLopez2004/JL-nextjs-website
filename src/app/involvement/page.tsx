      ...
      >
		<section style={{ width: '100%', display: 'flex', justifyContent: 'center', padding: '0', margin: '0' }}>
			...
			<Blog
        		...
        		body1Title="Event"
				body1={[
					"Michael Minella is an engineer, Java Champion, speaker, & author with over 21 years of enterprise development experience. He has been a member of the Spring OSS team for over 11 years and currently serves as the Director responsible for Spring R&D.",
